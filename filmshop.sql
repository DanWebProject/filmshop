...
INSERT INTO `filmcategory` (`id`, `film_id`, `category`) VALUES
(1, 47, 'action'),
(2, 48, 'thriller'),
(3, 49, 'comedy'),
(11, 50, 'adventure'),
...
INSERT INTO `films` (`id`, `name`, `description`, `price`, `image`, `quantity`) VALUES
...
-- AUTO_INCREMENT for table `filmcategory`
--
ALTER TABLE `filmcategory`

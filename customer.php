...
//learnt from http://www.w3schools.com/php/php_sessions.asp
 session_start(); 
 
if (!isset($_SESSION['user']) || empty($_SESSION['user'])) {
    header("Location: index.php");
    exit; //rediret to main page if user not registered
}
...
<body>
<div id="wb_Text2" style="position:absolute;left:13px;top:229px;width:171px;height:99px;z-index:11;">
...
<div id="wb_Image1" style="margin:0; padding:0; position:absolute; left:3px; top:497px; width:780px; height:79px; text-align:left; z-index:23; background-image: url(footer.gif); layer-background-image: url(footer.gif); border: 1px none #000000;">
<img src="body.gif" alt="" name="Image1" width="780" height="4" border="0" id="Image1" style="width:780px;height:92px;"></div>
<div id="wb_Image2" style="margin:0; padding:0; position:absolute; left:3px; top:36px; width:792px; height:55px; text-align:left; z-index:24;"><img src="header.gif" alt="" name="Image2" width="780" height="87" border="0" id="Image2" style="width:780px;height:87px;"></div>
<div id="wb_Image3" style="margin:0;padding:0;position:absolute;left:3px;top:119px;width:774px;height:429px;text-align:left;z-index:25;"><img src="body.gif" alt="" width="780" height="4" border="0" style="width:780px;height:379px;"></div>
<div id="wb_Text1" style="margin:0;padding:0;position:absolute;left:31px;top:49px;width:485px;height:36px;text-align:left;z-index:28;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
...
<div id="wb_Shape2" style="margin:0;padding:0;position:absolute;left:178px;top:133px;width:1px;height:403px;text-align:center;z-index:29;">
<img src="images/customer_0005.png" id="Shape2" align="top" alt="" title="" border="0" width="1" height="403"></div>
</div>
<div id="wb_Form1" style="position:absolute;left:224px;top:116px;width:799px;height:452px;z-index:26;">
  <form name="customer" method="post" action="customer.php" enctype="0" id="Form1">
    <div id="wb_Text3" style="margin:0;padding:0;position:absolute;left:113px;top:17px;width:438px;height:21px;text-align:left;z-index:0;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
    ...
    <div id="wb_Text5" style="margin:0;padding:0;position:absolute;left:7px;top:49px;width:103px;height:19px;text-align:left;z-index:1;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
        <div style="text-align:left"><span style="font-family:'Times New Roman';font-size:15px;">First name:</span></div>
      </div>
    </div>
    <div id="wb_Text4" style="margin:0;padding:0;position:absolute;left:7px;top:79px;width:103px;height:19px;text-align:left;z-index:2;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
        <div style="text-align:left"><span style="font-family:'Times New Roman';font-size:15px;">Last name:</span></div>
      </div>
    </div>
    <div id="wb_Text7" style="margin:0;padding:0;position:absolute;left:7px;top:109px;width:103px;height:19px;text-align:left;z-index:3;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
        <div style="text-align:left"><span style="font-family:'Times New Roman';font-size:15px;">E-mail:</span></div>
      </div>
    </div>
    <div id="wb_Text6" style="margin:0;padding:0;position:absolute;left:7px;top:139px;width:103px;height:19px;text-align:left;z-index:4;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
        <div style="text-align:left"><span style="font-family:'Times New Roman';font-size:15px;">Address:</span></div>
      </div>
    </div>
    <div id="wb_Text9" style="margin:0;padding:0;position:absolute;left:6px;top:200px;width:103px;height:19px;text-align:left;z-index:5;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
        <div style="text-align:left"><span style="font-family:'Times New Roman';font-size:15px;">City:</span></div>
      </div>
    </div>
    <div id="wb_Text8" style="margin:0;padding:0;position:absolute;left:7px;top:229px;width:103px;height:19px;text-align:left;z-index:6;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
        <div style="text-align:left"><span style="font-family:'Times New Roman';font-size:15px;">Post code:</span></div>
      </div>
    </div>
    <div id="wb_Text11" style="margin:0;padding:0;position:absolute;left:7px;top:261px;width:103px;height:19px;text-align:left;z-index:7;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
        <div style="text-align:left"><span style="font-family:'Times New Roman';font-size:15px;">State:</span></div>
      </div>
    </div>
    <div id="wb_Text10" style="margin:0;padding:0;position:absolute;left:7px;top:289px;width:103px;height:19px;text-align:left;z-index:8;border:0px #C0C0C0 solid;overflow-y:hidden;background-color:transparent;">
      <div style="font-family:'Segoe UI';font-size:12px;color:#000000;">
